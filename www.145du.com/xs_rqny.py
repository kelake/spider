...
url_shouYe = "https://www.145du.com/htm/novellist10/"
...
xs_rqny = respose.text.encode("iso-8859-1").decode("utf-8")
print(xs_rqny)
# ====================进行大分类解析====================
print("======================================================")
title_01 = re.findall(r'<a href="(.*?)target="_blank"', xs_rqny)
print(title_01)
#
# #取分类的链接地址
